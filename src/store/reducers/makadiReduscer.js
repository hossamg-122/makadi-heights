// this a higher order function above redux i use it to make a global reducer for the application it makes my work easy and i don't have to make types and reducers

const initState = {
  content: {},
  weather: { weatherIcon: "", temp: 0 },
};
